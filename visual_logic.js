 ...
 * Tue Apr 16 2024 16:39:30 GMT+0530 (India Standard Time)
...
var dictred, dictyellow, dictblue, dictviolet, clonedred, clonedyellow, clonedblue, clonedviolet;
...
dictred = {};
dictSet(dictred, 'x1', getObjTransform(clonedred, false, 'position', 'x'));
dictSet(dictred, 'y1', getObjTransform(clonedred, false, 'position', 'y'));
dictSet(dictred, 'z1', getObjTransform(clonedred, false, 'position', 'z'));

dictyellow = {};
dictSet(dictyellow, 'x2', getObjTransform(clonedyellow, false, 'position', 'x'));
dictSet(dictyellow, 'y2', getObjTransform(clonedyellow, false, 'position', 'y'));
dictSet(dictyellow, 'z2', getObjTransform(clonedyellow, false, 'position', 'z'));

dictblue = {};
dictSet(dictblue, 'x3', getObjTransform(clonedblue, false, 'position', 'x'));
dictSet(dictblue, 'y3', getObjTransform(clonedblue, false, 'position', 'y'));
dictSet(dictblue, 'z3', getObjTransform(clonedblue, false, 'position', 'z'));

dictviolet = {};
dictSet(dictviolet, 'x4', getObjTransform(clonedviolet, false, 'position', 'x'));
dictSet(dictviolet, 'y4', getObjTransform(clonedviolet, false, 'position', 'y'));
dictSet(dictviolet, 'z4', getObjTransform(clonedviolet, false, 'position', 'z'));
