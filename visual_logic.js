 ...
 * Sat Apr 20 2024 18:14:23 GMT+0530 (India Standard Time)
...
var clonedred, clonedyellow, clonedblue, clonedviolet, objlist, poslist, i;
...
setHTMLElemStyle('position', 'absolute', 'save', false);
setHTMLElemStyle('bottom', '100px', 'save', false);
setHTMLElemStyle('right', '7%', 'save', false);
setHTMLElemStyle('backgroundColor', 'orange', 'save', false);
setHTMLElemStyle('height', '45px', 'save', false);
setHTMLElemStyle('width', '60px', 'save', false);
setHTMLElemAttribute('innerHTML', 'Save', 'save', false);

addHTMLElement('button', 'load', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'absolute', 'load', false);
setHTMLElemStyle('bottom', '100px', 'load', false);
setHTMLElemStyle('right', '2%', 'load', false);
setHTMLElemStyle('backgroundColor', 'orange', 'load', false);
setHTMLElemStyle('height', '45px', 'load', false);
setHTMLElemStyle('width', '60px', 'load', false);
setHTMLElemAttribute('innerHTML', 'Load', 'load', false);

addHTMLElement('input', 'input', 'TO', ['CONTAINER'], false);
setHTMLElemStyle('position', 'absolute', 'input', false);
setHTMLElemStyle('bottom', '150px', 'input', false);
setHTMLElemStyle('right', '1%', 'input', false);
setHTMLElemStyle('backgroundColor', 'white', 'input', false);
setHTMLElemStyle('height', '25px', 'input', false);
setHTMLElemStyle('width', '152px', 'input', false);
setHTMLElemStyle('border', 'solid 1px black', 'input', false);
setHTMLElemStyle('borderRadius', '4px', 'input', false);
setHTMLElemAttribute('type', 'text', 'input', false);
setHTMLElemAttribute('value', 'lego_game1', 'input', false);

eventHTMLElem('click', 'save', false, function(event) {
  objlist = [];
  objlist = getObjectsFrom('Scene', 'ALL');
  poslist = {};
  for (var i_index in objlist) {
    i = objlist[i_index];
    if (isObjectVisible(i)) {
      dictSet(poslist, i, [getObjTransform(i, false, 'position', 'x'), getObjTransform(i, false, 'position', 'y'), getObjTransform(i, false, 'position', 'z')]);
    }
  }
  downloadFile(poslist, String(getHTMLElemAttribute('value', 'input', false)) + '.json');
});
